...
sudo sh -c "curl -L https://github.com/docker/compose/releases/download/v${COMPOSE_VERSION}/docker-compose-$(echo $(uname -s) | tr '[:upper:]' '[:lower:]')-`uname -m` > /usr/local/bin/docker-compose"
